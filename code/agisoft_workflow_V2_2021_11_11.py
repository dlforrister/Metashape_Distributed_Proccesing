...
# changed in 1.6 hightest = 0, high=1,medium =2,low=4,lowest=8
    ...
    def process(self, options):
        ...
        self.project.save()
        if options.step_one_align == F and options.step_two_dense_cloud == F:
...
parser.add_argument(
    '--step_one_align', type=bool, required=False, default=False,
    help='proceed with first step of processing, aligning photos and filtering sparse cloud'
)

parser.add_argument(
    '--step_two_dense_cloud', type=bool, required=False, default=False,
